...
public class JacksonObjectMapper extends ObjectMapper {
    ...
    public JacksonObjectMapper() {
        super();
        //Do not report an exception when receiving an unknown attribute
        this.configure(FAIL_ON_UNKNOWN_PROPERTIES, false);

        //Compatible handling of non-existent attributes when deserializing
        ...
        //Register function modules For example, custom serializers and deserializers can be added
