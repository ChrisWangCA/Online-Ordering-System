...
import com.itheima.ruiky.entity.*;
import com.itheima.ruiky.mapper.OrderMapper;
import com.itheima.ruiky.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
    ...
    public void submit(Orders orders) {
        ...
        //Prevent js from being disabled
        ...
        if (addressBook == null){
            throw new CustomException("Address is wrong");
        }
        //Insert one data to order table
        long orderId = IdWorker.getId();
        //It ensures accurate calculations even in a multithreaded environment
